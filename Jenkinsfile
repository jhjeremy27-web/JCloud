pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '234617061592.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '234617061592.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-backend'
    }
    ...
    stages {
        ...
        stage('Authenticate to ECR') {
            steps {
                withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'Susanoo']]) {
                    script {
                        sh '''
                            aws --version
